...
GRANT SELECT, INSERT, UPDATE ON APPLICATION_LOGS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT, INSERT, UPDATE ON TASK_EXECUTION_LOGS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT, INSERT, UPDATE ON FILE_PROCESSING_LOGS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT, INSERT, UPDATE ON API_REQUEST_LOGS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT, INSERT, UPDATE ON ERROR_LOGS TO ROLE IDENTIFIER($role_admin);

-- Grant access to views
GRANT SELECT ON V_RECENT_APPLICATION_LOGS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT ON V_RECENT_TASK_EXECUTIONS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT ON V_RECENT_ERRORS TO ROLE IDENTIFIER($role_admin);
GRANT SELECT ON V_FILE_PROCESSING_SUMMARY TO ROLE IDENTIFIER($role_admin);
